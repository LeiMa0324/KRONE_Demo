  ...
  <div className="w-full bg-white py-16 px-4 flex flex-col items-center justify-center z-10 relative">
    ...
    <div className="w-full max-w-5xl flex flex-col gap-12">
      ...
      <div className="flex flex-col items-center bg-neutral-50 rounded-lg shadow p-8">
        <h2 className="text-3xl font-bold mb-4">Visualize Tree</h2>
        <p className="text-center mb-6 text-neutral-700 text-lg">
      ...
      {/* Row 2: Sequence Tree */}
      <div className="flex flex-col items-center bg-neutral-50 rounded-lg shadow p-8">
        <h2 className="text-3xl font-bold mb-4">Sequence Tree</h2>
        <p className="text-center mb-6 text-neutral-700 text-lg">
        ...
        <p className="text-center text-neutral-700 text-lg mt-6">
